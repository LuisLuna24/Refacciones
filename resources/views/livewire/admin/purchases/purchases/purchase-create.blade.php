                    ...
                    @forelse($catalog as $item)
                        ...
                        <div wire:key="prod-{{ $item->id }}"
                            ...
                            {{ $isAdded
                                ...
                                : ($lowStock && $hasWarehouse
                                    ? 'cursor-pointer border-yellow-300 dark:border-yellow-700 ring-1 ring-yellow-100 dark:ring-yellow-900/20 focus:outline-none focus:ring-2 focus:ring-emerald-400 hover:-translate-y-0.5 hover:shadow-md hover:border-emerald-400'
                            ...
                            <div>
                                <div class="flex items-start justify-between gap-2 mb-2">
                                    ...
                                    @if (!$hasWarehouse)
                                        <span class="rounded px-1.5 py-0.5 text-[10px] font-bold text-gray-400 bg-gray-50 dark:bg-gray-700 dark:text-gray-300">Sin almacén</span>
                                    @elseif($lowStock)
                                        <span class="rounded px-1.5 py-0.5 text-[10px] font-bold text-yellow-600 bg-yellow-50 dark:text-yellow-500 dark:bg-yellow-900/30">Stock: {{ $stock }}</span>
                                    @else
                                        <span class="rounded px-1.5 py-0.5 text-[10px] font-bold text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-900/40">Stock: {{ $stock }}</span>
                                    @endif
                                </div>
                                ...
                                @if ($item->cost > 0)
                                    <p class="mt-1 text-[10px] text-gray-400">Último costo: ${{ number_format($item->cost, 2) }}</p>
                                @endif
                            </div>
                            ...
                            <div class="mt-2 flex items-center justify-end">
                                ...
                                @else
                                    <span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 dark:bg-emerald-900/40 dark:text-emerald-400 group-hover:bg-emerald-500 group-hover:text-white transition-colors" title="Agregar a la lista">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"></path>
                                        </svg>
                                    </span>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border-t-4 border-emerald-500">
                ...
                <div class="p-4 border-b dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50 rounded-t-xl">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800 dark:text-emerald-400">Recepción de Compra</h2>
                    ...
                    <form wire:submit.prevent="save" class="space-y-4">
                        ...
                        <div class="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl space-y-3 border border-emerald-100 dark:border-emerald-800">
                            ...
                            <div class="flex justify-between items-end border-t border-emerald-200 dark:border-emerald-700 pt-3">
                                <span class="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase">Total Compra</span>
